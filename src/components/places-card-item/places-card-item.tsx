  ...
  return (
    <div className={`${ratingClass}__rating rating`}>
      <div className={`${ratingClass}__stars rating__stars`}>
        <span style={RatingAttributes[ratingClass].style} />
...
function PlaceCardItem({ cardPlace }: PlaceCardItemProps): JSX.Element {
  ...
  return (
    <article className={'cities__card place-card'}>
      ...
      <div className={'cities__image-wrapper place-card__image-wrapper'}>
        <a href="#">
          <img className='place-card__image' src={cardPlace.previewImage} width={PlaceCardAttributes['cities'].width} height={PlaceCardAttributes['cities'].height} alt="Place image" />
        </a>
      </div>
